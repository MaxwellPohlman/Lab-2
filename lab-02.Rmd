...
author: "Team Name: Adam, Helen, Max, Liv, Sarah and Andrew"
date: "`r Sys.Date()`"
...
```
Africa has the largest number of coastal countries/territories.
...
plastic_data_all <- mutate(plastic_data_all, total_mismanage_plastic = mismanaged_plastic * population) 

plastic_data_all %>%
  group_by(region) %>%
  summarise(mean_per_region= mean(total_mismanage_plastic))


```
Asia is the highest
Oceania is the lowest
